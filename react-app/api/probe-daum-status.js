 ...
 *
 * ⚠️ 은퇴 예정 — 이건 영구 기능이 아니라 조사 장치다.
 *   평일 장전 토큰 + 토요일 휴장 토큰이 며칠 쌓여 값이 확정되면:
 *     ① _collectors/daum-stock.js의 DAUM_STATUS_MAP을 그 실측값으로 완성하고
 *     ② 이 크론(vercel.json 항목 포함) + api/probe-backup.js를 **동시에 은퇴**시킨다.
