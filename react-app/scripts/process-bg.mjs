 ...
 *
 * 버전 A(기본, forest-calendar.webp): blur 2,  brightness 0.75 — 원본에 가까운 선명함
 ...
 * 다크와 같은 출력 규격(webp, quality 85, 가로 폭 2560 기준 리사이즈, 500KB 상한
 * 경고)을 따르되, 두 가지가 다르다:
 *   1) blur 없음 — 원본이 눈 덮인 숲이라 다크(숲 실루엣)만큼 뭉갤 필요가 없다.
...
const DARK_VARIANTS = [
  { label: '다크 A', file: 'forest-calendar.webp',   blur: 2,  brightness: 0.75, saturation: 0.9 },
